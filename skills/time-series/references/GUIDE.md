...
This guide provides comprehensive documentation for the **time-series** skill in the custom-plugin-ai-data-scientist plugin.
...
```bash
# Invoke the skill
claude "time-series - [your task description]"

# Example
claude "time-series - analyze the current implementation"
```
...
def implement_time_series(input_data):
    """
