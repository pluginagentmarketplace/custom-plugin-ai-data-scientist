...
1. **Assess your current level** with `/assess`
2. **Choose learning path** based on results
3. **Start with relevant agent** (e.g., Programming Foundations)
4. **Build while learning** - theory + practice
